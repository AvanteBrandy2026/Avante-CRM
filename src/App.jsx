...
import { LayoutDashboard, Users, ClipboardList, Settings, TrendingUp, Phone, Mail, Search, Plus, X, ChevronRight, DollarSign, Award, Activity, Briefcase, Wine, ArrowUpRight, Save, RotateCcw, Target, BarChart3, Trash2, Download, FileSpreadsheet, UserPlus, Edit2, ShoppingCart, Package, ChevronDown, Bell } from 'lucide-react';
...
const SALES_REPS = ['Alex', 'Lehmarc', 'Loydz', 'Louis', 'Matthew'];
